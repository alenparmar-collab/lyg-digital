// app/fonts.ts : load the Ordinary Time fonts once, then add the variables to <html>.
...
// import "./globals.css";            // globals.css starts with @import "./tokens.css";
// import { fontVars } from "./fonts";
// import { resolveSeason } from "@/lib/season";
// export default async function RootLayout({ children }: { children: React.ReactNode }) {
//   const season = resolveSeason(null);          // pass a Supabase override here if you have one
//   return (
//     <html lang="en" data-season={season} className={fontVars}>
//       <body>
